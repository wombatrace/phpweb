   ...
   <b><a name="server">Server</a></b>
      <div style="padding: 5px 30px 5px;">
         <div class="row">
            ...
            <!-- <a href="changecoin" class='btn btn-default' role='button'>Change Coin</a> -->
         </div><!-- /.row -->
      </div><!-- /.padding -->
...
<div class="well">
   <b><a name="security">Security</a></b>
      <div style="padding: 5px 15px 5px;">
         ...
         <div class="row">
            <div class="col-lg-5">
               <form action="exportprivkey" method="POST"><input type="hidden">
                  <div class="input-group">
                     <span class="input-group-btn">
	                <button class='btn btn-default' type="submit" value="exportprivkey">Export Private Key</button>
                     </span>
                        <input class="form-control" type="text" name="address" placeholder="Address">
		     </span>
                  </div><!-- /input-group -->
